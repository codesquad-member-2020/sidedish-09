...
CREATE TABLE sidedish.delivery (
      id BIGINT NOT NULL AUTO_INCREMENT,
      type VARCHAR(45) NOT NULL,
      PRIMARY KEY (id))
ENGINE = InnoDB;

CREATE TABLE sidedish.sale (
      id BIGINT NOT NULL AUTO_INCREMENT,
      type VARCHAR(45) NOT NULL,
...
CREATE TABLE sidedish.thumbnail (
      id BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE sidedish.detailImage (
      id BIGINT NOT NULL AUTO_INCREMENT,
      url VARCHAR(100) NOT NULL,
      item_id BIGINT NOT NULL,
      PRIMARY KEY (id),
...
CREATE TABLE sidedish.item_delivery (
      item_id BIGINT NOT NULL,
...
CREATE TABLE sidedish.item_sale (
      item_id BIGINT NOT NULL,
...
CREATE TABLE sidedish.category_item (
